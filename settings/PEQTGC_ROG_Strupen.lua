...
settings.swap = { -- XXX impl
    ...
    ["slashdmg"] = "Chaotic Black Scimitar|Mainhand/Thunderclap|Offhand",
    ["bluntdmg"] = "Mace of Tortured Nightmares|Mainhand/Death's Head Mace|Offhand", -- WANT BLUNT Hammer of Rancorous Thoughts
